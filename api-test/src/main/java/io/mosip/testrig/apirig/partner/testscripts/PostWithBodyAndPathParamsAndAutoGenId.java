...
public class PostWithBodyAndPathParamsAndAutoGenId extends PMSRevampUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException {
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			response = postWithPathParamsBodyAndCookieForAutoGeneratedId(ApplnURI + testCaseDTO.getEndPoint(),
					inputJson, COOKIENAME, testCaseDTO.getRole(), testCaseDTO.getTestCaseName(), pathParams, idKeyName);
		}
