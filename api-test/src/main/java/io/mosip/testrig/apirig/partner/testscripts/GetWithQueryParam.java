...
public class GetWithQueryParam extends PMSUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException, SecurityXSSException {
		...
		String endpointUrl = ApplnURI + testCaseDTO.getEndPoint();
		if (endpointUrl.contains("$ID:")) {
			endpointUrl = replaceIdWithAutogeneratedId(endpointUrl, "$ID:");
		}
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			for (int i = 0; i < languageList.size(); i++) {
				response = getWithQueryParamAndCookie(endpointUrl,
