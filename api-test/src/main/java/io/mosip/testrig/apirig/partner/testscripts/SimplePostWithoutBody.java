...
public class SimplePostWithoutBody extends PMSRevampUtil implements ITest {
	private static final Logger logger = Logger.getLogger(SimplePostWithoutBody.class);
