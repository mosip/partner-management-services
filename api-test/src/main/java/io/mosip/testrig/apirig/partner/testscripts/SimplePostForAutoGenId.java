...
public class SimplePostForAutoGenId extends PMSUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO)
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			if (reqKeyName != null) {
				response = postWithBodyAndCookieForAutoGeneratedIdFromRequest(ApplnURI + testCaseDTO.getEndPoint(),
						inputJson, auditLogCheck, COOKIENAME, testCaseDTO.getRole(), testCaseDTO.getTestCaseName(),
						reqKeyName, idKeyName, false);
			} else {
