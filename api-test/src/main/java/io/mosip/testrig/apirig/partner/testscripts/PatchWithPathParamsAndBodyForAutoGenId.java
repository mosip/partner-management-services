...
public class PatchWithPathParamsAndBodyForAutoGenId extends PMSUtil implements ITest {
	private static final Logger logger = Logger.getLogger(PatchWithPathParamsAndBodyForAutoGenId.class);
	...
	public void test(TestCaseDTO testCaseDTO) throws AdminTestException, SecurityXSSException {
		...
		response = patchWithPathParamsBodyAndCookieForAutoGenId(ApplnURI + testCaseDTO.getEndPoint(),
