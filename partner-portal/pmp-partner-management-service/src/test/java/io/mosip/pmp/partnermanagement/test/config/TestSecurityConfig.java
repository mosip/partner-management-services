package io.mosip.pmp.partnermanagement.test.config;
...
public class TestSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public UserDetailsService userDetailsService() {
		...
		users.add(new User("partnermanager", "partnermanager",
						Arrays.asList(new SimpleGrantedAuthority("PARTNERMANAGER"))));
