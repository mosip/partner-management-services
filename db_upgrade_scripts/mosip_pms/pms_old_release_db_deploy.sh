### -- ---------------------------------------------------------------------------------------------------------
### -- Script Name		: PMS Release DB deploy
### -- Deploy Module 	: MOSIP PMS
### -- Purpose    		: To deploy PMS Database alter scripts for the release.       
...
#========================================DB Alter Scripts deployment process begins on PMS DB SERVER==================================
