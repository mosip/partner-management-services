...
**Step 2** -> DB Release deployment for all databases, run the **"mosip_release_pms_db_deployment.sh"** script with release version as parameter.  To access and exeute **"mosip_release_db_deployment.sh"** script, follow the below given sample commands:

<em> **Enter:-bash-4.2$** cd /home/madmin/database_release/ </em>

<em> **Enter:-bash-4.2$** bash mosip_release_pms_db_deployment.sh <release_version_number> </em>
...
**Step 1** -> DB Revoke deployment for all databases, run the **"mosip_revoke_pms_db_deployment.sh"** script with release version as parameter.  To access and exeute **"mosip_revoke_db_deployment.sh "** script, follow the below given commands:

<em> **Enter:-bash-4.2$** cd /home/madmin/database_release/ </em>

<em> **Enter:-bash-4.2$** bash mosip_revoke_pms_db_deployment.sh <release_version_number> </em>
