...
public class SecureBiometricInterfaceController {
	...
	@ResponseFilter
	@PutMapping
	@Operation(summary = "Service to update SecureBiometricInterface", description = "This API has been deprecated because it shouldn't be allowed for the user to update the SBI details.")
	...
	@Operation(summary = "Service to remove mapped device details with sbi", description = "This API has been deprecated because it shouldn't be allowed for the user to remove mapped device details with sbi")
