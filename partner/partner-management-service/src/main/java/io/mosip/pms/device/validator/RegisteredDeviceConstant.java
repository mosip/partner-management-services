...
public class RegisteredDeviceConstant {
	...
	static final String PURPOSEARR[] = { REGISTRATION, AUTH };

	// PurposeValidator values
	public static final String REGISTERED = "registered";
	public static final String RETIRED = "retired";
	public static final String REVOKED = "revoked";
	static final String STATUSARR[] = { REGISTERED, RETIRED, REVOKED };
	...
	static final String TYPEARR[] = { FINGERPRINT, SLAB_FINGERPRINT, IRIS_MONOCULAR, IRIS_BINOCULAR, FACE };
