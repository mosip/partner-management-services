...
public class FtmCertificateDownloadResponseDto {
    ...
    @Schema(description = "Date when the CA certificate was uploaded", example = "2024-07-15T10:00:00Z")
    private LocalDateTime caSignedCertTimeOfUpload;

    @Schema(description = "Date when the CA certificate will get expired", example = "2024-07-15T10:00:00Z")
    ...
    @Schema(description = "Date when the mosip certificate was uploaded", example = "2024-07-15T10:00:00Z")
    private LocalDateTime mosipSignedCertTimeOfUpload;

    @Schema(description = "Date when the mosip certificate will get expired", example = "2024-07-15T10:00:00Z")
