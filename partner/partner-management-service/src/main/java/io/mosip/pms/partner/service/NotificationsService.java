...
public interface NotificationsService {
    ...
    public ResponseWrapperV2<PageResponseV2Dto<NotificationsResponseV2Dto>> getNotificationsV2(Integer pageNo, Integer pageSize, NotificationsFilterDto filterDto);
