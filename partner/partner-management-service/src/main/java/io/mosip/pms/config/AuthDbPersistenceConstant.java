 ...
 * @since 1.2.0
 */
public class AuthDbPersistenceConstant {

	/**
	 * Private constructor for HibernatePersistenceConstants
	 */
	private AuthDbPersistenceConstant() {
	}

	/**
	 * The string constant jdbc driver
	 */
	public static final String JDBC_DRIVER = "mosip.datasource.authdevice.jdbc.driver";

	/**
	 * The string constant jdbc url
	 */
	public static final String JDBC_URL = "mosip.datasource.authdevice.jdbc.url";

	/**
	 * The string constant jdbc password
	 */
	public static final String JDBC_PASS = "mosip.datasource.authdevice.jdbc.password";

	/**
	 * The string constant jdbc schema
	 */
	public static final String JDBC_SCHEMA = "mosip.datasource.authdevice.jdbc.schema";

	/**
	 * The string constant jdbc user
	 */
	public static final String JDBC_USER = "mosip.datasource.authdevice.jdbc.user";
	/**
