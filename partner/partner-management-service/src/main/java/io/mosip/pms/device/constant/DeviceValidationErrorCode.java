...
public enum DeviceValidationErrorCode {
	...
	DEVICE_DOES_NOT_EXIST("ADM-DPM-001", "Device is marked Inactive or not found"),
	...
	MDS_DOES_NOT_EXIST("ADM-DPM-005", "deviceServiceVersion not found"),
	...
	private DeviceValidationErrorCode(final String errorCode, final String errorMessage) {
