...
public class PartnerManagementController {
	 ...
	 */
	@PreAuthorize("hasAnyRole(@authorizedRolesPms.getPutpartnersapikeypolicies())")
	 ...
	 */
	@PreAuthorize("hasAnyRole(@authorizedRolesPms.getPatchpartners())")
	 ...
	 */
	@PreAuthorize("hasAnyRole(@authorizedRolesPms.getGetpartners())")
	 ...
	 * @return response this class contains list of Auth/E-KYC Partners for the policy group
	 */
	@PreAuthorize("hasAnyRole(@authorizedRolesPms.getGetpartnersnew())")
	 ...
	 */
	@PreAuthorize("hasAnyRole(@authorizedRolesPms.getGetpartnersapikey())")
	...
	@PreAuthorize("hasAnyRole(@authorizedRolesPms.getPutpartnerspolicymapping())")
	...
	@PreAuthorize("hasAnyRole(@authorizedRolesPms.getPatchpartnerspolicyapikeystatus())")
