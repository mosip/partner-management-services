...
public class PartnerServiceController {
	...
	@Operation(summary = "Service to submit credential type request",
			description = "Persists credential type requests against an in-progress partner policy mapping request")
