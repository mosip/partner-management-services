...
public enum ErrorCode {
	...
	DUPLICATE_CREDENTIAL_TYPE_REQUEST("PMS_PRT_280",
			"Unable to submit credential type request. Please verify the request payload and ensure no duplicate or conflicting request/configuration already exists for the given partner and credential type.");
	/**
	 * The error code.
	 */
