...
public enum ErrorCode {
	...
	POLICY_NOT_EXIST("PMS_PRT_073","Policy does not exist."),
	...
	INVALID_GRANT_TYPE("PMS_ESI_009", "Invalid grant type provided."),
	INVALID_CLIENT_AUTH("PMS_ESI_010", "Invalid client authentication method provided."),
	ESIGNET_SERVICE_ERROR("PMS_ESI_011", "Error received from eSignet service: %s"),
	INVALID_CLIENT_ID_ESIGNET("PMS_ESI_012", "Invalid client id provided."),
	INVALID_CLIENT_NAME("PMS_ESI_013", "Invalid client name provided."),
	INVALID_CLAIM("PMS_ESI_014", "Invalid claim provided."),
	INVALID_ACR("PMS_ESI_015", "Invalid authentication context reference provided."),
	INVALID_URI("PMS_ESI_016", "Invalid URI provided."),
	INVALID_REDIRECT_URI("PMS_ESI_017", "Invalid redirect URI provided."),
	INVALID_CLIENT_NAME_VALUE("PMS_ESI_018", "Invalid client name value provided."),
	INVALID_LANGUAGE_CODE("PMS_ESI_019", "Invalid language code provided."),
	INVALID_ADDITIONAL_CONFIG("PMS_ESI_020", "Invalid additional config provided."),
	...
	UNABLE_TO_GET_NOTIFICATIONS("PMS_NOTIFICATION_ERROR_006", "Only partner admin will get notifications for ROOT_CERT_EXPIRY, INTERMEDIATE_CERT_EXPIRY, WEEKLY_SUMMARY and MISP_LICENSE_KEY_EXPIRY notification types."),
	...
	UNABLE_TO_GET_EXPIRING_CERTS_COUNT("PMS_NOTIFICATION_ERROR_014", "Partner Admin will only get the count of expiring ROOT_CERT_EXPIRY and INTERMEDIATE_CERT_EXPIRY certificates."),
	...
	WEEKLY_TYPE_NOT_SELECTED("PMS_NOTIFICATION_ERROR_017", "The selected notification type is invalid. Only 'WEEKLY_SUMMARY' type is allowed for this filter."),
	...
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_APIKEY_FILTER("PMS_NOTIFICATION_ERROR_020", "The selected notification type is invalid. Only 'API_KEY_EXPIRY' type is allowed for this filter."),
	ONLY_ROOT_INTERMEDIATE_PARTNER_TYPES_ARE_ALLOWED("PMS_NOTIFICATION_ERROR_021", "The selected notification type is invalid. Only 'ROOT_CERT_EXPIRY', 'INTERMEDIATE_CERT_EXPIRY', or 'PARTNER_CERT_EXPIRY' types are allowed for this filter."),
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_FTM_FILTER("PMS_NOTIFICATION_ERROR_022", "The selected notification type is invalid. Only 'FTM_CHIP_CERT_EXPIRY' type is allowed for this filter."),
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_SBI_FILTER("PMS_NOTIFICATION_ERROR_023", "The selected notification type is invalid. Only 'SBI_EXPIRY' type is allowed for this filter."),
	WEEKLY_TYPE_NOT_SUPPORTED_FOR_EXPIRY_DATE_FILTER("PMS_NOTIFICATION_ERROR_024", "The selected notification type is invalid. Please select a type other than 'WEEKLY_SUMMARY'."),
	...
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_MISP_FILTER("PMS_NOTIFICATION_ERROR_027", "The selected notification type is invalid. Only 'MISP_LICENSE_KEY_EXPIRY' type is allowed for this filter."),
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_POLICYNAME_FILTER("PMS_NOTIFICATION_ERROR_028", "The selected notification type is invalid. Either 'API_KEY_EXPIRY' or 'MISP_LICENSE_KEY_EXPIRY' type is allowed for this filter."),
