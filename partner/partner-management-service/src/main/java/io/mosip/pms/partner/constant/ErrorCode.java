...
public enum ErrorCode {
	...
	DUPLICATE_CREDENTIAL_MAPPING("PMS_PRT_007","Mapping exists for given policy and partner with this credential type"),
	...
	PENDING_APPROVAL_SBI("PMS_DEVICE_ERROR_009","Unable to process the request as the associated SBI is not approved."),
	...
	REJECTED_SBI("PMS_DEVICE_ERROR_028","Unable to process the request as the associated SBI is rejected"),
	DEACTIVATED_SBI("PMS_DEVICE_ERROR_029","Unable to process the request as the associated SBI is deactivated"),
	...
	DOWNLOAD_CERTIFICATE_FTM_REJECTED_ERROR("PMS_FTM_ERROR_008", "Cannot download the certificate for a rejected FTM"),
	...
	DOWNLOAD_CERTIFICATE_FTM_CERT_NOT_UPLOAD_ERROR("PMS_FTM_ERROR_011", "The certificate has not been uploaded for the given FTM"),
	UNABLE_TO_DOWNLOAD_ORIGINAL_FTM_CERTIFICATE("PMS_FTM_ERROR_012", "Unable to download original FTM certificate"),
	...
	INVALID_EXPIRY_DATE("PMS_NOTIFICATION_ERROR_016", "Please enter a valid expiry date."),
	WEEKLY_TYPE_NOT_SELECTED("PMS_NOTIFICATION_ERROR_017", "The selected notification type is invalid. Only 'weekly' type is allowed for this filter."),
	UNABLE_TO_DISMISS("PMS_NOTIFICATION_ERROR_018", "Only Partner Admin can dismiss this notification"),
	NOTIFICATION_STATUS_REQUIRED_IN_REQUEST("PMS_NOTIFICATION_ERROR_019", "Notification status is required in the request"),
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_APIKEY_FILTER("PMS_NOTIFICATION_ERROR_020", "The selected notification type is invalid. Only 'apikey' type is allowed for this filter."),
	ONLY_ROOT_INTERMEDIATE_PARTNER_TYPES_ARE_ALLOWED("PMS_NOTIFICATION_ERROR_021", "The selected notification type is invalid. Only 'root', 'intermediate', or 'partner' types are allowed for this filter."),
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_FTM_FILTER("PMS_NOTIFICATION_ERROR_022", "The selected notification type is invalid. Only 'ftm-chip' type is allowed for this filter."),
	INVALID_NOTIFICATION_TYPE_SELECTED_FOR_SBI_FILTER("PMS_NOTIFICATION_ERROR_023", "The selected notification type is invalid. Only 'sbi' type is allowed for this filter."),
	...
	INVALID_CREATED_FROM_DATE("PMS_NOTIFICATION_ERROR_025", "Please enter a valid created from date."),
