...
public enum PolicyManageEnum {
	...
	CREATE_POLICY_GROUP_FAILURE("PMS_PRT_415", AuditConstant.AUDIT_SYSTEM, "CREATE",
			"Policy Group Creation failed", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	GET_POLICY_GROUP("PMS_PRT_116", AuditConstant.AUDIT_SYSTEM, "GET",
			...
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	GET_ALL_POLICY_GROUPS("PMS_PRT_116", AuditConstant.AUDIT_SYSTEM, "GET",
	...
	CREATE_POLICY_FAILURE("PMS_PRT_437", AuditConstant.AUDIT_SYSTEM, "CREATE",
			"Create policy failed", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	GET_POLICY("PMS_PRT_187", AuditConstant.AUDIT_SYSTEM, "GET",
	...
	GET_POLICY_BY_APIKEY_FAILURE("PMS_PRT_488", AuditConstant.AUDIT_SYSTEM, "GET",
			"Getting policy for apikey failed", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	GET_POLICY_BY_APIKEY_SUCCESS("PMS_PRT_288", AuditConstant.AUDIT_SYSTEM, "GET",
			"Getting policy for apikey success", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	...
	GET_PARTNER_POLICY_SUCCESS("PMS_PRT_289", AuditConstant.AUDIT_SYSTEM, "GET",
			"Getting partner mapped policy sucess", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	GET_PARTNER_POLICY_FAILURE("PMS_PRT_489", AuditConstant.AUDIT_SYSTEM, "GET",
			"Getting partner mapped policy failure", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	...
	GET_CONFIG_VALUE_SUCCESS("PMS_PRT_291", AuditConstant.AUDIT_SYSTEM, "GET",
			"Getting config value success", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	GET_CONFIG_VALUE_FAILURE("PMS_PRT_491", AuditConstant.AUDIT_SYSTEM, "GET",
			"Getting config value failure", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	...
	SEARCH_POLICY_GROUP_SUCCESS("PMS_PRT_294", AuditConstant.AUDIT_SYSTEM, "SEARCH",
			"Searching policy group sucess", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	SEARCH_POLICY_GROUP_FAILURE("PMS_PRT_494", AuditConstant.AUDIT_SYSTEM, "SEARCH",
			"Searching policy group failed", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
	...
	UPDATE_POLICY_STATUS_FAILURE("PMS_PRT_484", AuditConstant.AUDIT_SYSTEM, "UPDATE",
			"Update policy status failure", AuditConstant.PARTNER_MODULE_ID, AuditConstant.PARTNER_MODULE_NAME, "NO_ID",
			"NO_ID_TYPE", AuditConstant.APPLICATION_NAME, AuditConstant.APPLICATION_ID),
