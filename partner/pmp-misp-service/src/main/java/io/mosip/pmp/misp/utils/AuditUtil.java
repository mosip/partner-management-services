...
import io.mosip.pmp.misp.entity.AuditRequestDto;
import io.mosip.pmp.misp.entity.AuditResponseDto;
...
public class AuditUtil {
	...
	private AuditResponseDto getAuditDetailsFromResponse(String responseBody) throws Exception {
		...
		if (!validationErrorsList.isEmpty()) {
			throw new io.mosip.pmp.misp.exception.ValidationException(validationErrorsList);
		}
