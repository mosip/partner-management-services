...
public enum ValidationErrorCode {
	...
	INVALID_INPUT_VALUE("PMS_REQUEST_ERROR_007", "Invalid input provided for field: '%s'. Only letters, numbers, spaces, and the following special characters are allowed: . , @ # & ( ) \\ - ' ? _ ! \" : ; =");
