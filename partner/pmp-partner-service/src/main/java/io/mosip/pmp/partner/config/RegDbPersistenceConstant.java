 ...
 *
 */
public class RegDbPersistenceConstant {

	/**
	 * Private constructor for HibernatePersistenceConstants
	 */
	private RegDbPersistenceConstant() {
	}

	/**
	 * The string constant jdbc driver
	 */
	public static final String JDBC_DRIVER = "mosip.datasource.regdevice.jdbc.driver";

	/**
	 * The string constant jdbc url
	 */
	public static final String JDBC_URL = "mosip.datasource.regdevice.jdbc.url";

	/**
	 * The string constant jdbc password
	 */
	public static final String JDBC_PASS = "mosip.datasource.regdevice.jdbc.password";

	/**
	 * The string constant jdbc schema
	 */
	public static final String JDBC_SCHEMA = "mosip.datasource.regdevice.jdbc.schema";

	/**
	 * The string constant jdbc user
	 */
	public static final String JDBC_USER = "mosip.datasource.regdevice.jdbc.user";
	/**
